...
As we stated above, Naive Bayes Method assume a nearly impossible
condition when building models: all features are conditionally
independent. While molecule's properties are highly correlated,
we may think about PCA(Principal Component Analysis) method to firstly lower the correlation between features we selected.
However, this will make it hard to do interpretations.
